...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["id"]) && isset($_POST["tantsija_hinne2"])) {
    $kask = $yhendus->prepare("UPDATE `Tantsupaarid` SET `Hinne2`=? WHERE `TantsijaID`=?");
    $kask->bind_param("ii", $_POST["tantsija_hinne2"], $_POST["id"]);
    $kask->execute();
}
